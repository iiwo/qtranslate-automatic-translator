<?php
# codigo baseado em: http://msdn.microsoft.com/en-us/library/ff512406.aspx
...
Class HTTPTranslator {
    ...
    public function translate($from, $to, $text) {
        $url = 'http://api.microsofttranslator.com/V2/Ajax.svc/Translate?text='. urlencode($text) . '&from=' . $from . '&to=' . $to . '&contentType=text/html';
        $trad = utf8_decode($this->curlRequest($url));
        $trad = substr($trad, 2, -1);
